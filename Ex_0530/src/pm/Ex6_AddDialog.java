...
public class Ex6_AddDialog extends JDialog {
	...
	JPanel p1, p2, p3, p4, p5, p6; //p6은 저장 취소 버튼
	...
	public Ex6_AddDialog(Ex6_Frame f) {
		...
		this.setLayout(new GridLayout(6, 1)); // 6행 1열 
		...
		this.setBounds(400, 200, 200, 280);
		...
		ok_bt.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				// Ex6_Frame에 있는 arraylist에 저장한 후 
				// JTable에 표현하고 돌아온다.
				f.addData(empno, ename, pos, hdate, deptno); 
				// 수행을 다하고 
				dispose();
			}
		});
