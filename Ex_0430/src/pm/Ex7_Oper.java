...
public class Ex7_Oper {
	...
	public static void main(String[] args) {
		...
		// && : AND
		// || : OR
		// !  : NOT(결과에 대한 부정 값의 반대값으로 나옴)
		
		boolean result = (v1 >= 10) && (v1 < 20);
		// (v1 >= 10)이 true라는 값이 나와야 뒤에 있는 (v1 < 20)의 식을 수행함 
		// 따라서 왼쪽의 식이 false일경우 뒤에 있는 식은 수행하지도 않음 
		System.out.println("v1의 값이 10대인가?" + result);
	}
